    ...
    <div className="min-h-screen flex flex-col">
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 space-y-6">
            <h1 className="text-4xl md:text-6xl font-bold leading-tight">
              Blessed Wing <span className="text-brand-gold-light">Tech Academy</span>
            </h1>
            <p className="text-lg md:text-xl text-emerald-50 max-w-2xl font-light italic">
              "Donner à la jeunesse haïtienne les outils technologiques pour bâtir son avenir — 
            ...
            <p className="text-md text-emerald-100 max-w-2xl">
              ...
              les forces de plusieurs passionnés, formateurs et professionnels, nous pouvons réaliser 
              de grands exploits numériques en Haïti.
            </p>
            <div className="pt-4">
              <Link 
                href="/rejoindre" 
          ...
          <div className="max-w-5xl mx-auto space-y-16">
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-600 max-w-3xl mx-auto text-lg">
                Bâtir un écosystème en Haïti où grandir sans moyens financiers n'empêche plus d'accéder 
                aux compétences qui ouvrent des portes professionnelles. BWTA se conçoit comme un futur 
                laboratoire informatique complet au service de la jeunesse.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-slate-50 p-8 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600">
                  L'accès à une formation de qualité est géographiquement et financièrement limité.
                  Un jeune motivé se retrouve souvent écarté d'un secteur qui offre pourtant de réelles perspectives (développement, entrepreneuriat).
                </p>
              </div>
              ...
              <div className="bg-slate-50 p-8 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600">
                  Une offre pédagogique structurée sur 2 ans. Trois volets au lancement : 
                  <strong className="text-brand-green"> Technique informatique</strong>, 
                  <strong className="text-brand-green"> Bureautique</strong>, et 
                  <strong className="text-brand-green"> Anglais professionnel</strong> comme outil indispensable.
                </p>
              </div>
              ...
              <div className="bg-slate-50 p-8 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600">
                  Le manque de moyens ne doit jamais être une barrière. Notre modèle repose sur des bourses 
                  totales ou partielles et un système de parrainage individuel créant un lien concret 
                  entre donateurs et étudiants.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 px-6 sm:px-12 lg:px-24 bg-slate-50">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start gap-12">
            <div className="md:w-1/3 flex flex-col items-center">
              ...
              <h3 className="text-xl font-bold text-gray-900">Bentzky Louis (Bentz)</h3>
            ...
            <div className="md:w-2/3 space-y-6">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Le projet est porté par <strong>Bentzky Louis</strong>, ingénieur en informatique (UJEPH), développeur Full-Stack, administrateur système Linux et designer. Fort de plus de <strong>5 années d'expérience</strong>, il est le fondateur de 
                <a href="https://bwt.bittonik.com" target="_blank" className="text-brand-turquoise hover:underline mx-1 font-semibold">Blessed Wing Technology (BWT)</a>
                et ShopTonik.
              </p>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 space-y-4">
                ...
                <ul className="space-y-3 text-gray-600">
                  <li className="flex items-start gap-2">
                    ...
                    <span><strong>Plus de 50 projets digitaux livrés</strong> (applications web, solutions cloud, cybersécurité) via BWT.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="text-brand-green shrink-0 mt-1" size={18} />
                    <span><strong>Formateur expérimenté :</strong> A déjà formé et encadré plus de 200 apprenants sur les principes du design et du numérique.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="text-brand-green shrink-0 mt-1" size={18} />
                    <span><strong>Double légitimité :</strong> À la fois expert technique (React, Django, Linux) et responsable jeunesse engagé dans sa communauté.</span>
                  </li>
                </ul>
              </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="relative p-6 border-l-4 border-brand-turquoise bg-slate-50">
                ...
                <h4 className="text-lg font-bold text-gray-900 mb-2">Phase 1 : Lancement</h4>
                <p className="text-gray-600 text-sm">Ouverture prévue le <strong>15 août 2026</strong>. Démarrage de la première cohorte (20-30 étudiants) avec les ressources disponibles (ordinateurs, Starlink, Smart TV).</p>
              </div>
              <div className="relative p-6 border-l-4 border-brand-gold bg-slate-50">
                ...
                <p className="text-gray-600 text-sm">Renforcement du matériel informatique et pédagogique. Recrutement de formateurs supplémentaires et officialisation légale de l'institution.</p>
              </div>
              <div className="relative p-6 border-l-4 border-brand-green bg-slate-50">
                ...
                <h4 className="text-lg font-bold text-gray-900 mb-2">Phase 3 : Vision Long Terme</h4>
          ...
          <div className="max-w-4xl mx-auto text-center space-y-10 relative z-10">
            <div className="space-y-4">
              ...
              <p className="text-lg text-emerald-100 max-w-2xl mx-auto">
                ...
                des passionnés du <strong className="text-white">numérique</strong> et des <strong className="text-white">entrepreneurs</strong> pour 
                bâtir ensemble cette vision. Car avec l'inclusion de plusieurs, nous pouvons produire bien plus.
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-brand-gold/50 rounded-2xl p-8 max-w-2xl mx-auto shadow-xl">
              <h3 className="text-2xl font-bold text-brand-gold-light mb-4 flex items-center justify-center gap-3">
                <Target size={28} /> Processus Hautement Sélectif
              </h3>
              <p className="text-emerald-50 text-lg leading-relaxed">
                Il s'agit d'un appel à candidature compétitif pour constituer l'équipe fondatrice et la future association. 
                Afin de garantir l'excellence de notre académie, <strong className="text-white bg-brand-gold/40 px-2 py-1 rounded">seuls les 15 meilleurs profils seront retenus</strong>.
              </p>
      ...
      <footer className="bg-slate-900 text-slate-400 py-12 px-6 text-center border-t border-slate-800">
        <div className="max-w-4xl mx-auto space-y-4">
          ...
          <p>Lajeune, Bohoc, Haïti</p>
          <div className="flex justify-center space-x-6 pt-4">
            <a href="mailto:contact@bwta.bittonik.com" className="hover:text-brand-turquoise-light transition-colors">contact@bwta.bittonik.com</a>
            <span>•</span>
            <span>+509 4057 6045</span>
          </div>
          <div className="pt-8 text-sm text-slate-500">
            &copy; {new Date().getFullYear()} BWTA - Blessed Wing Technology. Tous droits réservés.
          </div>
        </div>
      </footer>
    </div>
